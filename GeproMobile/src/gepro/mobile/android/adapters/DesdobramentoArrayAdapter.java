...
public class DesdobramentoArrayAdapter extends BaseAdapter {
	
	List<Desdobramento> _data = null;
	LayoutInflater _inf;

	public DesdobramentoArrayAdapter(Context ctx,  List<Desdobramento> data) {
